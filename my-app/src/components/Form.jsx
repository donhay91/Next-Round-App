            ...
            <Center bg="#17A7AD">
                ...
                <FormControl>
                    <Container centerContent>
                        <FormLabel htmlFor="name" centerContent color="#17A7AD">Please Enter Your Names:</FormLabel>
                    </Container>
                        <InputArea 
                            onAdd={addNames} />
                        <Divider></Divider>
                        ...
                        <Container centerContent>
                            <HStack padding={5}>
                                <Button isDisabled={isEmpty} bg="#17A7AD" color="#F8DFBD" _hover={{ bg: "#F8DFBD", color: "#17A7AD" }} onClick={onSubmit}>Submit</Button>
                            </HStack>
                        </Container>
                    </FormControl>}  
                 </Box>   
